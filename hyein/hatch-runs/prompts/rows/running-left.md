Create a single horizontal sprite strip for the Codex app digital pet `hyein` in the state `running-left`.
...
Animation action: leftward flying locomotion loop inspired by the hovering flight style language of classic super-cute cartoon superheroes.
